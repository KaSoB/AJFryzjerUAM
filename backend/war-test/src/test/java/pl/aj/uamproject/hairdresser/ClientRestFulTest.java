...
class ClientRestFulTest {
    ...
    @Test
    void shouldReturnClientInfoWithId1() throws IOException {
        restTest("http://localhost:8080/war-1.0.0-SNAPSHOT/client/1", "client/1.json");
    }

    @Test
    public void shouldReturnAllIClientInfo() throws IOException {
        restTest("http://localhost:8080/war-1.0.0-SNAPSHOT/client", "client/all.json");
    }
